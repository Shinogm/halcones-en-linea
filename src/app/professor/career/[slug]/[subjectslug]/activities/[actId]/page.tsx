						...
						<li key={v4()} className="flex gap-2">
							<Link
								href={`/professor/career/${params.slug}/${
									params.subjectslug
								}/activities/${activity.id}/${s.id}?${new URLSearchParams(
									searchParams,
								).toString()}`}
								className="bg-itesus-tertiary px-2 py-1 flex-1 rounded-lg"
							>
							...
							<div className="bg-itesus-tertiary rounded-lg px-2 py-1 w-[10%] text-itesus-primary ">
								{s.calification}
							</div>
						</li>
					))}
